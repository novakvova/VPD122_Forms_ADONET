...
namespace MyWinForms.Migrations
{
    ...
    [Migration("20220904111708_Add tbl Role and tlbUserRoles")]
    partial class AddtblRoleandtlbUserRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWinForms.Data.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyWinForms.Data.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("MyWinForms.Data.AppUserRole", b =>
                {
                    b.HasOne("MyWinForms.Data.AppRole", "Role")
                        .WithMany("AppUserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWinForms.Data.AppUser", "User")
                        .WithMany("AppUserRoles")
